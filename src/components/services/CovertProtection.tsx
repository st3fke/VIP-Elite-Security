...
export function CovertProtection() {
  ...
  const features = t('servicesDetails.covertProtection.features', { returnObjects: true }) as string[];

  return (
    <section ref={ref} id='covert-protection' className="bg-gradient-to-b from-gray-900 to-black py-20">
          ...
          >
            <div className="flex items-center gap-3 mb-6">
              ...
              <h2 className="text-4xl font-bold text-white">
                {t('servicesDetails.covertProtection.title')}
              </h2>
            </div>
            <p className="text-gray-400 text-lg leading-relaxed mb-6">
              {t('servicesDetails.covertProtection.description1')}
            </p>
            <p className="text-gray-400 text-lg leading-relaxed mb-8">
              {t('servicesDetails.covertProtection.description2')}
            </p>
