        ...
        >
          <div>
            <div className="flex items-center gap-3 mb-6">
              ...
              <h2 className="text-4xl font-bold text-white">Journey Management</h2>
            </div>
            <p className="text-gray-400 text-lg mb-6">
              Our journey management specialists ensure that complex travel
              itineraries are secure, efficient, and seamlessly supported from
              start to finish.
            </p>
          ...
          <div className="relative">
            <img
              src="https://images.unsplash.com/photo-1500530855697-b586d89ba3ee?w=800&q=70"
              alt="Journey Management"
